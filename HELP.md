...
* The original package name 'com.ssns.demo.websocket-poc' is invalid and this project uses 'com.ssns.demo.websocket_poc' instead.
...
* [WebSocket](https://docs.spring.io/spring-boot/docs/3.3.4-SNAPSHOT/reference/htmlsingle/index.html#messaging.websockets)
